...
const Footer = () => {
    return (
        <Box p={{ base: 5, md: 8 }} maxW="100%" borderTop={"3px solid #F0F0F0"}>
            <Stack
                spacing={{ base: 8, md: 0 }}
            ...
            >
                <Box maxW="300px" ml={"5%"}>
                    <Link href="https://templateskart.com" isExternal>
                        <Image w="100px" src="https://rb.gy/fvf1l" alt="TemplatesKart" />
                    </Link>
            ...
            <Stack direction={{ base: 'column', md: 'row' }}   spacing={3} justifyContent="space-between">
                <Text fontSize="md" ml="5%">
                    Built by{' '}
                    <Link
                        href="https://github.com/dinesh07sengar"
                ...
                <Stack spacing={2} direction={{ base: 'column', md: 'row' }} mr={"5%"}>
